...
.addField('***قوة الحماية :***: ' , message.guild.verificationLevel)
.addField('***نطاق السيرفر :globe_with_meridians: ***: ' , message.guild.region)
.addField('***عدد الرومات : ***: ' , message.guild.defaultChannel)
.addField('***حجم الرومات ***: ' , message.guild.channels.size)
.addField('***عدد الرتب : ***: ' , message.guild.roles.size)
.addField('***عدد الاعضاء :***: ' , message.guild.memberCount)
.addField('***تم صنع السيرفر في :***: ' ,year + "-"+ month +"-"+ day)
.setColor("#51cde6")
